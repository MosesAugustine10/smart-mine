...
export function LayoutWrapper({ children }: { children: React.ReactNode }) {
  ...
  const isPublicRoute = pathname === "/" || pathname?.startsWith("/login") || pathname?.startsWith("/auth") || pathname?.startsWith("/landing") || pathname?.startsWith("/chimbo") || pathname?.startsWith("/gate")
