...
const buttonVariants = (variant: string = "default", size: string = "default") => {
  ...
  }[variant as "default"] || "bg-primary text-primary-foreground shadow hover:bg-primary/90"
  ...
  const sizeClasses = {
    ...
    icon: "h-9 w-9"
  }[size as "default"] || "h-9 px-4 py-2"

  return cn(baseClass, variantClasses, sizeClasses)
}
