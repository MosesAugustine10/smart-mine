...
import { RiskAssessmentForm } from "@/components/safety/risk-assessment-form"
        ...
        <div className="p-8 space-y-8 max-w-5xl mx-auto">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-amber-500/10 border-2 border-amber-500/20 rounded-xl text-amber-700">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">Risk Assessor Matrix</span>
                </div>
            </div>

            <DashboardHeader 
                title="Log Hazard Risk Assessment" 
                description="Securely verify and validate operational risks and control measures." 
            />
